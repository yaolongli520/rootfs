...
TCL_EXTRA_CFLAGS=' -O2 -pipe -g -feliminate-unused-debug-types -fdebug-prefix-map=/usr/include=/usr/src/debug/tcl/8.6.6-r0 -fdebug-prefix-map=/home/bamboo/build/4.9.51-8mq-ga/fsl-imx-xwayland/temp_build_dir/build_fsl-imx-xwayland/tmp/sysroots/x86_64-linux= -fdebug-prefix-map=/home/bamboo/build/4.9.51-8mq-ga/fsl-imx-xwayland/temp_build_dir/build_fsl-imx-xwayland/tmp/sysroots/imx8mqevk=  -pipe '
...
TCL_LD_FLAGS='-Wl,-O1 -Wl,--hash-style=gnu -Wl,--as-needed -Wl,--export-dynamic '
...
TCL_RANLIB='aarch64-poky-linux-ranlib'
...
# compiled.
TCL_SRC_DIR='/usr/include/tcl8.6.6'
