...
TK_LIBS='-lX11 -lXft -lfontconfig -lfreetype -lfontconfig  -lpthread -ldl -lz  -lpthread -lieee -lm'
...
# build directory.
TK_BUILD_LIB_SPEC='-L/usr/lib -ltk8.6'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/usr/lib -ltkstub8.6'
...
TK_BUILD_STUB_LIB_PATH='/usr/lib/libtkstub8.6.a'
